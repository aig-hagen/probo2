...
class Result(Base):
    ...
    solver_id = Column(Integer, ForeignKey('solvers.solver_id'))
    ...
    correct_solved = Column(Boolean,default=False)
    incorrect_solved = Column(Boolean,default=False)
    no_reference = Column(Boolean,default=False)
